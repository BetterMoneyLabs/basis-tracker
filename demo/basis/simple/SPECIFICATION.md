...
**Example:**
```
6995ccf33c8a09705612e6ee3808bb4cedb48cb7b7c019ecdc68b74e7ed912a4 0000000002faf080 00000195e97f7800
││                                                               ││              ││
└─ Key (Blake2b256 of owner||receiver)                           └─ Debt (50000000) └─ Timestamp (1743379200000)
```
...
```bash
sbt "runMain basis.contracts.BasisNoteRedeemer \
  --note-json <file> \
  --reserve-box <id|auto> \
  --tracker-box <id|auto> \
...
```bash
# Run main Basis contract test suite
cd scala
sbt "testOnly basis.contracts.BasisSpec"

# Run token-based reserve contract tests
sbt "testOnly basis.contracts.BasisTokenSpec"
```
