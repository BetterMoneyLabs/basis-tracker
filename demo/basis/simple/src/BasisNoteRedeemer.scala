 ...
 *
 * Usage:
 *   sbt "runMain basis.contracts.BasisNoteRedeemer --note-json note.json --reserve-box <box_id>"
 *
...
object BasisNoteRedeemer extends App {
  ...
  def printUsage(): Unit = {
    ...
    println("  sbt \"runMain basis.contracts.BasisNoteRedeemer --note-json note.json --reserve-box abc123... --tracker-box xyz789...\"")
    println()
    println("  # Auto-fetch box IDs from node scan API:")
    println("  sbt \"runMain basis.contracts.BasisNoteRedeemer --note-json note.json --reserve-box auto --tracker-box auto\"")
    println()
