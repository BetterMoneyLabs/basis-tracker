...
object ParticipantKeys {
   ...
   */
  lazy val reserveErgoTree: String = AddressUtils.deriveErgoTreeFromContract(BasisConstants.basisErgoTree)

  /**
   * Reserve (Basis) address derived from ergoTree
   */
  lazy val reserveAddress: String = BasisConstants.basisAddress.toString
