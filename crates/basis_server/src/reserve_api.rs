...
use crate::{ApiResponse, AppState, error_response, success_response};
...
pub async fn get_reserves_by_issuer(
    ...
    let reserves = vec![
        SerializableReserveInfo {
            ...
            tracker_nft_id: Some("a1b2c3d4e5f67788990011223344556677889900112233445566778899001122".to_string()),
    ...
    tracing::info!("Returning {} reserves for issuer {}", reserves.len(), pubkey_hex);
    
    (
        StatusCode::OK,
        Json(success_response(reserves)),
    )
}
