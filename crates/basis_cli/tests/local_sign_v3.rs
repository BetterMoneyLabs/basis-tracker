...
// This test is ignored because it documents a known upstream limitation:
// ergo-lib 0.28.0 does not support ErgoTree header version 3. Re-enable once
// an ergo-lib release adds v3 support or the project switches to a custom
// box-deserialization workaround.
#[ignore = "Blocked on ergo-lib ErgoTree v3 support (ergo-lib 0.28.0)"]
#[test]
